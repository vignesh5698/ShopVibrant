...
public class l2h extends MainActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.l2h);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BottomSheetDialog dialog = new BottomSheetDialog(l2h.this);
                ...
                pop.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(l2h.this, com.example.vignesh.womenfootwear.pop.class);
                ...
                new1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(l2h.this, com.example.vignesh.womenfootwear.new1.class);
                        startActivity(intent);
                    }
                });
                ...
                dis.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(l2h.this, com.example.vignesh.womenfootwear.dis.class);
                        startActivity(intent);
                    }
                });
                ...
                low.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(l2h.this, com.example.vignesh.womenfootwear.l2h.class);
                        startActivity(intent);
                    }
                });
                ...
                high.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(l2h.this, com.example.vignesh.womenfootwear.h2l.class);
                        startActivity(intent);
                    }
                });
            }
        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(l2h.this,"Refine",Toast.LENGTH_SHORT).show();
            }
        });
