...
public class h2l extends MainActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h2l);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BottomSheetDialog dialog = new BottomSheetDialog(h2l.this);
                ...
                pop.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(h2l.this, com.example.vignesh.womenfootwear.pop.class);
                ...
                new1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(h2l.this, com.example.vignesh.womenfootwear.new1.class);
                        startActivity(intent);
                    }
                });
                ...
                dis.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(h2l.this, com.example.vignesh.womenfootwear.dis.class);
                        startActivity(intent);
                    }
                });
                ...
                low.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(h2l.this, com.example.vignesh.womenfootwear.l2h.class);
                        startActivity(intent);
                    }
                });
                ...
                high.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(h2l.this, com.example.vignesh.womenfootwear.h2l.class);
                        startActivity(intent);
                    }
                });
            }
        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(h2l.this,"Refine",Toast.LENGTH_SHORT).show();
            }
        });
